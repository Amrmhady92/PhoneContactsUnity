...
// This script is just a tool, if I commented it all out, is only because it throws some errors at build on Android, should be fixed now with the UNITY_EDITOR
#if(UNITY_EDITOR)
